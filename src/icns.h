...
/* a simple linked list for sharing multiple elements all at once */
typedef struct icns_element_list_t {
  struct icns_element_list_t *next;
...
#define ICNS_DARK_MODE_DATA               0xFDD92FA8  // "\xFD\xD9\x2F\xA8" icns file without TOC or magic header
...
#define ICNS_16x16_2X_32BIT_ARGB_DATA     0x69633131 // "ic11" or "ic05"
#define ICNS_16x16_32BIT_ARGB_DATA        0x69633034 // "ic04"
...
#define ICNS_48x48_32BIT_DATA             0x69683332  // "ih32" or "icp6"
...
#define ICNS_32x32_32BIT_DATA             0x696C3332  // "il32" or "icp5"
#define ICNS_32x32_1BIT_MASK              0x49434E23  // "ICN#"
#define ICNS_32x32_8BIT_MASK              0x6C386D6B  // "l8mk"

#define ICNS_24x24_2X_32BIT_DATA          0x53423234  // "SB24"
#define ICNS_24x24_32BIT_DATA             0x73623234  // "sb24"

#define ICNS_18x18_2X_32BIT_DATA          0x69637342  // "icsB"
#define ICNS_18x18_32BIT_ARGB_DATA        0x69637362  // "icsb"
...
#define ICNS_16x16_32BIT_DATA             0x69733332  // "is32" or "icp4"
...
#define ICNS_NULL_SIZE                    0x00000000
...
#define ICNS_STATUS_MISSING_ELEMENT   5
#define ICNS_STATUS_MISSING_LIST      6


extern const icns_type_t kICNSTypes[];
extern const icns_size_t kICNSTypesCount;

extern const char *kICNSTypeNames[];
extern const icns_size_t kICNSTypeNamesCount; 

extern const icns_bool_t kICNSTrue;
extern const icns_bool_t kICNSFalse;
...
extern void icns_read_be(void *outp, void *inp, int size);
extern void icns_read_le(void *outp, void *inp, int size);
extern void icns_write_be(void *outp, void *inp, int size);
